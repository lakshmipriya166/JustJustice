 ...
 * @author User
 */
public class GCRIMINAL extends javax.swing.JFrame {

    /**
     * Creates new form GCRIMINAL
     */
    public GCRIMINAL() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setBounds(380, 160, 150, 24);
        ...
        jTextField6.setBounds(590, 260, 120, 23);

        jLabel5.setFont(new java.awt.Font("Berlin Sans FB", 0, 18)); // NOI18N
        jLabel5.setText("PERMANENT ADDRESS:");
        jLabel5.setEnabled(false);
        getContentPane().add(jLabel5);
        jLabel5.setBounds(360, 360, 209, 24);
        ...
        jLabel10.setBounds(250, 20, 293, 43);
        ...
        jTextField1.setBounds(170, 160, 131, 23);
        ...
        jTextField7.setBounds(590, 310, 120, 23);
        ...
        jScrollPane1.setBounds(80, 400, 218, 91);
        ...
        jTextField2.setBounds(170, 220, 131, 23);
        ...
        jTextField5.setBounds(590, 210, 120, 23);

        jLabel6.setFont(new java.awt.Font("Berlin Sans FB", 0, 18)); // NOI18N
        jLabel6.setText("MOBILE NUMBER:");
        jLabel6.setEnabled(false);
        getContentPane().add(jLabel6);
        jLabel6.setBounds(380, 260, 190, 24);

        jLabel7.setFont(new java.awt.Font("Berlin Sans FB", 0, 18)); // NOI18N
        jLabel7.setText("EMAIL ID:");
        jLabel7.setEnabled(false);
        getContentPane().add(jLabel7);
        jLabel7.setBounds(380, 310, 130, 24);
        ...
        jTextField3.setBounds(170, 290, 127, 23);
        ...
        jTextField4.setBounds(590, 160, 120, 23);

        jLabel4.setFont(new java.awt.Font("Berlin Sans FB", 0, 18)); // NOI18N
        jLabel4.setText("ADDRESS:");
        jLabel4.setEnabled(false);
        getContentPane().add(jLabel4);
        jLabel4.setBounds(80, 360, 91, 24);

        jLabel9.setFont(new java.awt.Font("Berlin Sans FB", 0, 18)); // NOI18N
        jLabel9.setText("UNDERSECTION:");
        jLabel9.setEnabled(false);
        getContentPane().add(jLabel9);
        jLabel9.setBounds(380, 210, 190, 24);
        ...
        jScrollPane2.setBounds(360, 400, 208, 91);

        jLabel1.setFont(new java.awt.Font("Berlin Sans FB", 0, 18)); // NOI18N
        jLabel1.setText("CASE NO:");
        jLabel1.setEnabled(false);
        getContentPane().add(jLabel1);
        jLabel1.setBounds(10, 160, 120, 24);

        jLabel3.setFont(new java.awt.Font("Berlin Sans FB", 0, 18)); // NOI18N
        jLabel3.setText("FATHER'S NAME:");
        jLabel3.setEnabled(false);
        getContentPane().add(jLabel3);
        jLabel3.setBounds(10, 290, 160, 24);

        jLabel2.setFont(new java.awt.Font("Berlin Sans FB", 0, 18)); // NOI18N
        jLabel2.setText("CLIENT'S NAME:");
        jLabel2.setEnabled(false);
        getContentPane().add(jLabel2);
        jLabel2.setBounds(10, 220, 160, 24);

        jLabel0.setFont(new java.awt.Font("Berlin Sans FB", 0, 18)); // NOI18N
        jLabel0.setText("SEARCH BY:");
        getContentPane().add(jLabel0);
        jLabel0.setBounds(152, 73, 108, 24);

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "CASE NO.", "CLIENT NAME", "FATHER'S NAME", "CC NO.", "UNDERSECTION", "MOBILE NO.", "EMAIL", "ADDRESS", "PERMANENT ADDRESS" }));
        ...
        jComboBox1.setBounds(301, 76, 198, 26);

        jTextField0.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        ...
        jTextField0.setBounds(440, 110, 144, 29);

        jLabel00.setFont(new java.awt.Font("Berlin Sans FB", 0, 18)); // NOI18N
        jLabel00.setEnabled(false);
        getContentPane().add(jLabel00);
        jLabel00.setBounds(140, 110, 193, 29);
        ...
        jButton1.setBounds(520, 73, 183, 27);
        ...
        jButton3.setBounds(28, 21, 71, 27);
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        // TODO add your handling code here:
        jLabel00.setEnabled(true);
        jTextField0.setEnabled(true);
        jLabel00.setText("Enter "+String.valueOf(jComboBox1.getSelectedItem()));
    }//GEN-LAST:event_jComboBox1ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String x=jTextField0.getText();
        ...
        try
        {
            ...
            String q="select * from cdet_cr where cno='"+x+"'||cname='"+x+"'||fname='"+x+"'||ccno='"+x+"'||usec='"+x+"'||mno='"+x+"'||email='"+x+"'||addr='"+x+"'||paddr='"+x+"';";
            ...
            {
                JOptionPane.showMessageDialog(null,"Client detail found!");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GCRIMINAL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
