 ...
 * @author User
 */
public class GCIVIL extends javax.swing.JFrame {

    /**
     * Creates new form GCIVIL
     */
    public GCIVIL() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setBounds(340, 150, 140, 24);
        ...
        jTextField6.setBounds(510, 240, 120, 23);

        jComboBox1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "OS NO.", "CLIENT NAME", "FATHER'S NAME", "IA NO.", "UNDERSECTION", "MOBILE NO.", "EMAIL", "ADDRESS", "PERMANENT ADDRESS" }));
        ...
        jScrollPane2.setBounds(300, 380, 208, 91);
        ...
        jButton1.setBounds(440, 70, 183, 27);
        ...
        jTextField0.setForeground(new java.awt.Color(0, 51, 51));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String q="select * from cdet_ci where osno='"+x+"'||cname='"+x+"'||fname='"+x+"'||iano='"+x+"'||usec='"+x+"'||mno='"+x+"'||email='"+x+"'||addr='"+x+"'||paddr='"+x+"';";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GCIVIL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
